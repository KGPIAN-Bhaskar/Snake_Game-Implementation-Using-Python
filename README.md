...
## 🚀 Key Features
- Responsive keyboard-based controls
- Dynamic snake growth upon food consumption
- Boundary collision and self-collision detection
- Real-time score and high-score tracking
- Configurable movement speed
- Lightweight graphical interface using Turtle
---
...
- State management using Python data structures
